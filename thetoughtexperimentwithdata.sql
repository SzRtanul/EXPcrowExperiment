...
--
-- Name: getaccesfullschemasfromgroups(bigint, text); Type: FUNCTION; Schema: sysadmin; Owner: postgres
--

CREATE FUNCTION sysadmin.getaccesfullschemasfromgroups(usertoken bigint, schemacharchain text) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
 DECLARE
 groups int[];
 ...
 BEGIN
        benne := true;
         ...
         schemalist := string_to_array(schemacharchain, ';');
...
ALTER FUNCTION sysadmin.getaccesfullschemasfromgroups(usertoken bigint, schemacharchain text) OWNER TO postgres;
...
--
-- Data for Name: alany; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.alany (id, kodnev, nev, nem, szuletes, fajid) FROM stdin;
\.


--
-- Data for Name: alanytulajdonsag; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.alanytulajdonsag (vizsgalatid, tulajdonsagid, mennyi, kevesebb, egyenlo) FROM stdin;
\.


--
-- Data for Name: alanyvizsgalat; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.alanyvizsgalat (id, vizsgalatelojegyzesid, alanyid, vizsgalatidopont, megjegyzes) FROM stdin;
\.


--
-- Data for Name: alkotoresz; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.alkotoresz (id, alkotoresztipusid, alkotoreszidazonbelul, elnevezes) FROM stdin;
\.


--
-- Data for Name: alkotoresztipus; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.alkotoresztipus (id, elnevezes) FROM stdin;
\.


--
-- Data for Name: alkotoresztulajdonsag; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.alkotoresztulajdonsag (vizsgalatid, alkotoreszid, tulajdonsagid, mennyi, kevesebb, egyenlo, leiras) FROM stdin;
\.


--
-- Data for Name: anyag; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.anyag (id, nev, mennyiseg, mertekegysegid) FROM stdin;
\.


--
-- Data for Name: atjaras; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.atjaras (epulethelysegid, epulethelysegidcel) FROM stdin;
\.


--
-- Data for Name: ceg; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.ceg (id, nev) FROM stdin;
\.


--
-- Data for Name: epulethelyseg; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.epulethelyseg (id, elnevezes) FROM stdin;
\.


--
-- Data for Name: epulethelysegferohely; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.epulethelysegferohely (epulethelysegid, kiserletcsoportid, mennyien) FROM stdin;
\.


--
-- Data for Name: erintettalkotoresz; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.erintettalkotoresz (alkotoreszid, tunetid) FROM stdin;
\.


--
-- Data for Name: etelintolarencia; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.etelintolarencia (etetesid, anyagid) FROM stdin;
\.


--
-- Data for Name: etetes; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.etetes (id, alanyid, datum, munkatarsidseged) FROM stdin;
\.


--
-- Data for Name: faj; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.faj (id, elnevezes) FROM stdin;
\.


--
-- Data for Name: fajalkotoresze; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.fajalkotoresze (fajid, alkotoreszid) FROM stdin;
\.


--
-- Data for Name: halottalany; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.halottalany (alanyid, halalidopontja, leiras) FROM stdin;
\.


--
-- Data for Name: kiserlet; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserlet (id, elnevezes, leiras) FROM stdin;
\.


--
-- Data for Name: kiserletlepes; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepes (id, kiserletlepescsoportid, elnevezes, epulethelysegid, leiras) FROM stdin;
\.


--
-- Data for Name: kiserletlepescsoport; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepescsoport (id, elnevezes, leiras) FROM stdin;
\.


--
-- Data for Name: kiserletlepesfeltetelesugras; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesfeltetelesugras (id, kiserletlepesid, kiserletlepesidcel, rekurzivnakszant) FROM stdin;
\.


--
-- Data for Name: kiserletlepesfeltetelesugrasfeltetel; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesfeltetelesugrasfeltetel (kiserletlepesfeltetelesugrasid, vizsgalatelojegyzesid) FROM stdin;
\.


--
-- Data for Name: kiserletlepessorrend; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepessorrend (kiserletlepesid, hanyadik, kiserletlepesidszuloelem, csoportszam) FROM stdin;
\.


--
-- Data for Name: kiserletlepesvegrehajtas; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesvegrehajtas (id, probalkozas, klcshozzarendelesvegrehajtasid, kiserletlepesid, alanyid, mikor, munkatarsid, sikeres, leiras) FROM stdin;
\.


--
-- Data for Name: kiserletlepesvegrehajtasesemeny; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesvegrehajtasesemeny (hanyadik, kiserletlepesvegrehajtasid, mikor, gyorsleiras, elemzes) FROM stdin;
\.


--
-- Data for Name: kiserletlepesvegrehajtasetetes; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesvegrehajtasetetes (kiserletlepesvegrehajtasid, etetesid) FROM stdin;
\.


--
-- Data for Name: kiserletlepesvegrehajtasvalasztottalany; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesvegrehajtasvalasztottalany (kiserletlepesvegrehajtasid, alanyid) FROM stdin;
\.


--
-- Data for Name: kiserletlepesvegrehajtasvalasztottlehetoseg; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesvegrehajtasvalasztottlehetoseg (kiserletlepesvegrehajtasid, valaszthatoid) FROM stdin;
\.


--
-- Data for Name: kiserletlepesvegrehajtasvizsgalat; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletlepesvegrehajtasvizsgalat (kiserletlepesvegrehajtasid, alanyvizsgalatid) FROM stdin;
\.


--
-- Data for Name: kiserletresztvevo; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletresztvevo (klcshozzarendelesvegrehajtasid, alanyid, csoportszam, bevonasdatuma, kivonasdatuma, alanyvizsgalata) FROM stdin;
\.


--
-- Data for Name: kiserletvegrehajtas; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.kiserletvegrehajtas (id, kiserletid, mikor, munkatarsid) FROM stdin;
\.


--
-- Data for Name: klcshozzarendeles; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.klcshozzarendeles (id, fazis, kiserletid, kiserletlepescsoportid, csoportszam, elnevezes, leiras) FROM stdin;
\.


--
-- Data for Name: klcshozzarendelesvegrehajtas; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.klcshozzarendelesvegrehajtas (id, kiserletvegrehajtasid, klcshozzarendelesid, kezd, vege, munkatarsidvezeto) FROM stdin;
\.


--
-- Data for Name: lepesheztartozovizsgalat; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.lepesheztartozovizsgalat (kiserletlepesid, vizsgalatelojegyzesid) FROM stdin;
\.


--
-- Data for Name: megetetendoetelek; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.megetetendoetelek (kiserletlepesid, anyagid, mennyiseg) FROM stdin;
\.


--
-- Data for Name: megetetettetelek; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.megetetettetelek (etetesid, anyagid, mennyiseg, elteroidopont) FROM stdin;
\.


--
-- Data for Name: munkatars; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.munkatars (id, szerepkorid) FROM stdin;
\.


--
-- Data for Name: oklevel; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.oklevel (munkatarsid, oktatasiintezmenyid, szakid, kezdeseve, vegzeseve, ertekeles, befejezetlen) FROM stdin;
\.


--
-- Data for Name: oktatasiintezmeny; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.oktatasiintezmeny (id, nev) FROM stdin;
\.


--
-- Data for Name: recept; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.recept (anyagid, anyagidosszetevo, variacionevid, mennyiseg) FROM stdin;
\.


--
-- Data for Name: receptvariacionev; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.receptvariacionev (id, nev) FROM stdin;
\.


--
-- Data for Name: szak; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.szak (id, oktatasiintezmenyid, szakmegnevezes) FROM stdin;
\.


--
-- Data for Name: szemely; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.szemely (id, szemelyiszam, nev, anyjaneve, szuletesiido) FROM stdin;
\.


--
-- Data for Name: szerepkor; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.szerepkor (id, elvevezes) FROM stdin;
\.


--
-- Data for Name: tapasztalat; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.tapasztalat (munkatarsid, cegid, munkaviszonykezdete, munkakor, leiras, munkaviszonyvege) FROM stdin;
\.


--
-- Data for Name: tartalmaz; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.tartalmaz (vizsgalatid, alkotoreszid, anyagid, mennyiseg, kevesebb, egyenlo) FROM stdin;
\.


--
-- Data for Name: tulajdonsag; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.tulajdonsag (id, elnevezes, mertekegysegid) FROM stdin;
\.


--
-- Data for Name: tunet; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.tunet (id, elnevezes, leiras) FROM stdin;
\.


--
-- Data for Name: tunetallapot; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.tunetallapot (vizsgalatid, tunetid, sulyossagmerteke, kevesebb, egyenlo, leiras) FROM stdin;
\.


--
-- Data for Name: valasztasilehetoseg; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.valasztasilehetoseg (kiserletlepesid, valaszthatoid, csoportszam) FROM stdin;
\.


--
-- Data for Name: valaszthato; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.valaszthato (id, elnevezes) FROM stdin;
\.


--
-- Data for Name: valaszthatoalany; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.valaszthatoalany (klcshozzarendelesvegrehajtasid, alanyid, valaszthatoalanytipusid) FROM stdin;
\.


--
-- Data for Name: valaszthatoalanytipus; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.valaszthatoalanytipus (id, kiserletlepesid, vizsgalatelojegyzesid, mennyi, csoportszam) FROM stdin;
\.


--
-- Data for Name: valaszthatoanyag; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.valaszthatoanyag (kiserletlepesid, anyagid, csoportszam) FROM stdin;
\.


--
-- Data for Name: vizsgalatelojegyzes; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.vizsgalatelojegyzes (id, vizsgalattipusid, mintfeltetelletezik) FROM stdin;
\.


--
-- Data for Name: vizsgalattipus; Type: TABLE DATA; Schema: admin; Owner: postgres
--

COPY admin.vizsgalattipus (id, elnevezes) FROM stdin;
\.


--
-- Data for Name: bearertoken; Type: TABLE DATA; Schema: sysadmin; Owner: postgres
--

COPY sysadmin.bearertoken (token, felhasznaloid) FROM stdin;
5	1
\.


--
-- Data for Name: engedelyezettsema; Type: TABLE DATA; Schema: sysadmin; Owner: postgres
--

COPY sysadmin.engedelyezettsema (jogcsoportid, semaid, hozzafereskategoriaid) FROM stdin;
1	11	\N
1	2200	\N
\.
...
--
-- Data for Name: felhasznalo; Type: TABLE DATA; Schema: sysadmin; Owner: postgres
--

COPY sysadmin.felhasznalo (id, felhasznalonev, email, jelszohash) FROM stdin;
1	zalka                         	zalkajanos@valamim.hu	inhash
\.


--
-- Data for Name: hozzafereskategoria; Type: TABLE DATA; Schema: sysadmin; Owner: postgres
--

COPY sysadmin.hozzafereskategoria (id, nev) FROM stdin;
\.


--
-- Data for Name: jogcsoport; Type: TABLE DATA; Schema: sysadmin; Owner: postgres
--

COPY sysadmin.jogcsoport (id, nev) FROM stdin;
1	EXAj
\.


--
-- Data for Name: jogcsoporthozzarendeles; Type: TABLE DATA; Schema: sysadmin; Owner: postgres
--

COPY sysadmin.jogcsoporthozzarendeles (jogcsoportid, felhasznaloid) FROM stdin;
1	1
\.


--
-- Data for Name: mertekegyseg; Type: TABLE DATA; Schema: szotar; Owner: postgres
--

COPY szotar.mertekegyseg (id, elnevezes, rovidites) FROM stdin;
\.


--
-- Name: AlanyVizsgalat_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."AlanyVizsgalat_id_seq"', 1, false);


--
-- Name: Alany_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Alany_id_seq"', 1, false);


--
-- Name: AlkotoreszTipus_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."AlkotoreszTipus_id_seq"', 1, false);


--
-- Name: Alkotoresz_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Alkotoresz_id_seq"', 1, false);


--
-- Name: Anyag_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Anyag_id_seq"', 1, false);


--
-- Name: Ceg_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Ceg_id_seq"', 1, false);


--
-- Name: EpuletHelyseg_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."EpuletHelyseg_id_seq"', 1, false);


--
-- Name: Etetes_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Etetes_id_seq"', 1, false);


--
-- Name: Faj_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Faj_id_seq"', 1, false);


--
-- Name: KLCsHozzarendelesVegrehajtas_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KLCsHozzarendelesVegrehajtas_id_seq"', 1, false);


--
-- Name: KLCsHozzarendeles_fazis_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KLCsHozzarendeles_fazis_seq"', 1, false);


--
-- Name: KLCsHozzarendeles_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KLCsHozzarendeles_id_seq"', 1, false);


--
-- Name: KiserletLepesCsoport_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KiserletLepesCsoport_id_seq"', 1, false);


--
-- Name: KiserletLepesVegrehajtasEsemeny_hanyadik_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KiserletLepesVegrehajtasEsemeny_hanyadik_seq"', 1, false);


--
-- Name: KiserletLepesVegrehajtas_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KiserletLepesVegrehajtas_id_seq"', 1, false);


--
-- Name: KiserletLepesVegrehajtas_probalkozas_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KiserletLepesVegrehajtas_probalkozas_seq"', 1, false);


--
-- Name: KiserletLepes_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KiserletLepes_id_seq"', 1, false);


--
-- Name: KiserletVegrehajtas_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KiserletVegrehajtas_id_seq"', 1, false);


--
-- Name: Kiserlet_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Kiserlet_id_seq"', 1, false);


--
-- Name: KiserletlepesFeltetelesUgras_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."KiserletlepesFeltetelesUgras_id_seq"', 1, false);


--
-- Name: Munkatars_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Munkatars_id_seq"', 1, false);


--
-- Name: OktatasiIntezmeny_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."OktatasiIntezmeny_id_seq"', 1, false);


--
-- Name: Szak_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Szak_id_seq"', 1, false);


--
-- Name: Személy_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Személy_id_seq"', 1, false);


--
-- Name: Szerepkor_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Szerepkor_id_seq"', 1, false);


--
-- Name: Tualjdonsag_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Tualjdonsag_id_seq"', 1, false);


--
-- Name: Tunet_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Tunet_id_seq"', 1, false);


--
-- Name: ValaszthatoAlanyTipus_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."ValaszthatoAlanyTipus_id_seq"', 1, false);


--
-- Name: Valaszthato_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."Valaszthato_id_seq"', 1, false);


--
-- Name: VizsgalatElojegyzes_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."VizsgalatElojegyzes_id_seq"', 1, false);


--
-- Name: VizsgalatTipus_id_seq; Type: SEQUENCE SET; Schema: admin; Owner: postgres
--

SELECT pg_catalog.setval('admin."VizsgalatTipus_id_seq"', 1, false);


--
-- Name: Felhasznalo_id_seq; Type: SEQUENCE SET; Schema: sysadmin; Owner: postgres
--

SELECT pg_catalog.setval('sysadmin."Felhasznalo_id_seq"', 1, false);


--
-- Name: JogCsoport_id_seq; Type: SEQUENCE SET; Schema: sysadmin; Owner: postgres
--

SELECT pg_catalog.setval('sysadmin."JogCsoport_id_seq"', 1, false);


--
-- Name: Mertekegyseg_id_seq; Type: SEQUENCE SET; Schema: szotar; Owner: postgres
--

SELECT pg_catalog.setval('szotar."Mertekegyseg_id_seq"', 1, false);
